...
switch (indice_local_storage.indice_post) {
    ...
    case '2':
        ...
        elements_html.data_text.innerHTML = 'A Internet das Coisas (IoT) permite que objetos do        cotidiano se conectem à internet e compartilhem dados entre        si. Isso inclui desde geladeiras que fazem compras sozinhas        até sensores em equipamentos industriais que informam        quando precisam de manutenção. Com a IoT, é possível        monitorar e controlar diversos aspectos da vida, do consumo        de energia à segurança pública.';
        break;
    ...
    case '3':
        ...
        validado antes de ser adicionado à rede. O blockchain tem
    ...
    case '4':
        ...
        virtuais em ambientes reais. Isso tem implicações em
        ...
        e mídias. Estas são apenas algumas das tendências que estão
